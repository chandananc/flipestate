...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { address: @apartment.address, buit_year: @apartment.buit_year, cost: @apartment.cost, name: @apartment.name, rooms: @apartment.rooms, sqft: @apartment.sqft }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { address: @apartment.address, buit_year: @apartment.buit_year, cost: @apartment.cost, name: @apartment.name, rooms: @apartment.rooms, sqft: @apartment.sqft }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
